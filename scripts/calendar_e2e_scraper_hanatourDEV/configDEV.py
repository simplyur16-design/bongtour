...
LIST_REFRESH_TIMEOUT_MS = _int_env("HANATOUR_E2E_LIST_REFRESH_MS", 32000)
...
LIST_REFRESH_RETRY_TIMEOUT_MS = _int_env("HANATOUR_E2E_LIST_REFRESH_RETRY_MS", 20000)
# 두 번의 list_wait 실패 후 강제 스크롤·재클릭 뒤 세 번째 list_wait 타임아웃
LIST_REFRESH_FORCE_TIMEOUT_MS = _int_env("HANATOUR_E2E_LIST_REFRESH_FORCE_MS", 22000)
