# -*- coding: utf-8 -*-
"""노랑풍선(ybtour) 전용 calendar E2E 설정 (공용 분기 없음)."""
import os
...
# _scroll_until_list_stable (3단계) 튜닝 노브 — Railway 등 운영 튜닝용. 시그니처 기본값(5/2/150)과 동일하지만 env 로 override 가능.
YBTOUR_E2E_SCROLL_MAX_ITERS = _int_env("YBTOUR_E2E_SCROLL_MAX_ITERS", 5)
YBTOUR_E2E_SCROLL_STABLE_STREAK = _int_env("YBTOUR_E2E_SCROLL_STABLE_STREAK", 2)
YBTOUR_E2E_SCROLL_POLL_MS = _int_env("YBTOUR_E2E_SCROLL_POLL_MS", 150)
...
def get_output_path(city: str) -> Path:
    ...
    return OUTPUT_DIR / f"ybtour_{safe}_calendar.json"
