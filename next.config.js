...
function buildContentSecurityPolicy() {
  const directives = [
    ...
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://partner.talk.naver.com https://ssl.pstatic.net https://pstatic.net",
    ...
    "style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://fonts.googleapis.com https://ssl.pstatic.net https://pstatic.net",
    "style-src-elem 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://fonts.googleapis.com https://ssl.pstatic.net https://pstatic.net",
    "style-src-attr 'unsafe-inline'",
    "img-src 'self' data: blob: https: http:",
    "font-src 'self' data: https://cdn.jsdelivr.net https://fonts.gstatic.com",
    "frame-src 'self' https://www.googletagmanager.com https://www.google.com https://partner.talk.naver.com https://talk.naver.com https://ssl.pstatic.net https://pstatic.net",
    ...
    "connect-src 'self' https://bongtour.com https://www.bongtour.com https://*.supabase.co https://cdn.jsdelivr.net https://fonts.googleapis.com https://fonts.gstatic.com https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://www.google.com https://partner.talk.naver.com https://talk.naver.com https://ssl.pstatic.net https://pstatic.net",
