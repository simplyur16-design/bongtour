...
| **2c** | App store release + **ASO listing SSOT** (`apps/simplyur-mobile/store-listing/aso/`) — Buy → web Eximbay handoff ✅; EAS build checklist [`STORE_RELEASE.md`](../apps/simplyur-mobile/STORE_RELEASE.md) |
