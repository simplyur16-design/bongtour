...
export const metadata: Metadata = {
  ...
  description:
    "대만·홍콩 등 일부 국가 eSIM 사용 전 여행자 인증(실명 인증) 방법과 ICCID 확인 기준을 안내합니다.",
...
export default function EsimTravelerVerificationPage() {
  return (
    <EsimBenefitPageShell
      ...
      countriesBullets={[
        "ICCID가 8985234로 시작 → 여행자 인증 필요",
        "90000 또는 8985235로 시작 → 인증 불필요",
        "ICCID는 주문 완료 화면·이메일·마이페이지에서 확인할 수 있어요.",
      ]}
      noticeHeading="인증 방법"
      noticeLink={{
        href: TRAVELER_VERIFICATION_URL,
        label: "여행자 인증 페이지 열기 (홍콩·대만)",
      }}
      noticeItems={[
