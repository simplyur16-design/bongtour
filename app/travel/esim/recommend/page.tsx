...
export default function RecommendPage() {
  ...
  const allCountriesExceptKorea = useMemo(
    () => COUNTRY_OPTIONS.filter((c) => c.code !== "kr"),
    [],
  );
  ...
  const popularCountries = useMemo(
    () =>
      ...
      ).filter(Boolean) as typeof COUNTRY_OPTIONS,
            ...
            {selectedCodes.length > 0 && (
              <div className="mb-6 flex flex-wrap items-center gap-2">
                ...
                {selectedCodes.map((code) => {
                  const country = allCountriesExceptKorea.find((c) => c.code === code);
            ...
            <div className="mb-6">
              <div className="relative">
                <input
                  ...
                  placeholder="도시나 국가를 검색하세요 (예: 도쿄, 일본, JP)"
