...
type Props = {
  /** 서버 User-Agent(iPhone 등) — welpay 분기 즉시 확정 */
  initialMobileWelpay: boolean;
};

export default function WelcomepayPaymentClient({ initialMobileWelpay }: Props) {
  ...
  const [uaMobile, setUaMobile] = useState(initialMobileWelpay);
