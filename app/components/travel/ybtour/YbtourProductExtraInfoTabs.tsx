...
import YbtourStructuredLocalOptionsSection from '@/app/components/travel/ybtour/YbtourStructuredLocalOptionsSection'
...
export default function YbtourProductExtraInfoTabs({
  product,
  uiOptionalRows,
        ...
        {tab === 'local' && (
          <div className="space-y-6">
            ...
            {showStructuredLocalOptionsForUi ? (
              <YbtourStructuredLocalOptionsSection
                embedded
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-xl border border-bt-border-soft bg-bt-surface-alt/80 p-4 text-left">
              ...
              {excludedDisplay.trim() ? (
                <ul className="bt-wrap mt-3 list-none space-y-2 text-sm font-medium leading-relaxed text-bt-body">
                  {excludedDisplay
                    .split('\n')
                    .map((l) => l.trim())
                    .filter(Boolean)
                    .map((line, i) => (
                      <li key={i} className="pl-0 whitespace-pre-wrap">
                        {line}
                      </li>
                    ))}
                </ul>
