    ...
    <div className="min-h-screen bg-bt-surface pb-40">
      ...
      {departureCollectOpen ? (
        <div
          ...
          aria-modal="true"
          aria-busy="true"
          aria-labelledby="ybm-dep-collect-title"
          aria-describedby="ybm-dep-collect-desc"
        >
          ...
          <div className="relative w-full max-w-md rounded-2xl border border-bt-border-soft bg-bt-surface px-6 py-7 shadow-lg">
            <h2 id="ybm-dep-collect-title" className="text-center text-base font-semibold text-bt-card-title">
              출발일 정보 수집 중
            </h2>
            <p id="ybm-dep-collect-desc" className="mt-3 text-center text-sm leading-relaxed text-bt-body">
