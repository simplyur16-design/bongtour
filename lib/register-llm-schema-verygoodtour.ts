/** [verygoodtour] register-llm-schema */
/**
...
import type { PricePromotionSnapshot } from './price-promotion-verygoodtour'
...
export type RegisterParsed = {
  ...
  /** 내부: PackageDetail HTML 상세카드 자동수집(미리보기 adapterPrefetchRan) */
  verygoodtourDetailCollectRan?: boolean
  verygoodtourDetailCollectSummary?: string | null
}
