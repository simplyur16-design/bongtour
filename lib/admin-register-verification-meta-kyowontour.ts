/** [kyowontour] admin-register-verification-meta */
/**
...
import type { PricePromotionFieldIssue } from '@/lib/price-promotion-kyowontour'
...
function kyowontourVerificationFlightLabel(brandKey: string, s: string | null | undefined): string | null {
  if (brandKey !== 'kyowontour') return s ?? null
...
export function buildRegisterVerificationBundle(args: {
  ...
  return {
    ...
    display: {
      flight: {
        airlineName: kyowontourVerificationFlightLabel(
          brandKey,
        ...
        departureSegmentText: kyowontourVerificationFlightLabel(
          brandKey,
          parsed.departureSegmentText ?? productDraft?.departureSegmentText ?? null
        ),
        returnSegmentText: kyowontourVerificationFlightLabel(
          brandKey,
