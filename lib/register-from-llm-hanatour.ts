...
} from '@/lib/register-schedule-extract-hanatour'
import {
...
- destination 은 **여행도시** 경로·제목 권역(미서부·미동부 등)을 우선한다. 프로모션·호텔·#태그 한 줄을 destination 으로 쓰지 말 것.
...
${text.slice(0, 16000)}`
  ...
  const destResolved = resolveHanatourRegisterDestination({
