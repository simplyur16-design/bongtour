...
const SHOPPING_HEADER_ALIASES = {
  shoppingItem: ['쇼핑품목', '품목', '쇼핑항목', '쇼핑 품목', '구입품목', '구매품목', '노랑 쇼핑'],
...
import { parseOptionalTourTableRowsFromRawText, parseShoppingStopsFromLines } from '@/lib/structured-tour-signals-kyowontour'
