/** [verygoodtour] register-preview-payload */
import type { DeparturePreviewRow } from '@/lib/departure-preview'
import type { PricePromotionFieldIssue, PricePromotionSnapshot } from '@/lib/price-promotion-verygoodtour'
import type { RegisterExtractionFieldIssue } from '@/lib/register-llm-schema-verygoodtour'
import type { DayHotelPlan } from '@/lib/day-hotel-plans-verygoodtour'
import type { RegisterPreviewSsotMeta } from '@/lib/register-preview-ssot-verygoodtour'
import type { DetailBodyParseSnapshot } from '@/lib/detail-body-parser'
import type { RegisterCorrectionPreviewV1 } from '@/lib/register-correction-types-verygoodtour'
import type { RegisterVerificationV1 } from '@/lib/admin-register-verification-meta-verygoodtour'
