...
- **routeText**(필수에 가깝게): 그날 방문 도시·관광지를 **본문 이동 순서 그대로** ' - '(공백-하이픈-공백)로 연결. 관광 2곳 이상이면 반드시 채움. 예: "홍콩 - 하버 시티 - 소호 거리 - 타이쿤 - 빅토리아 피크". 공항·호텔만 있는 일차는 null.
- description만 짧게 쓰지 말 것 — **「A에서 B로 이동」 한 줄 요약**은 금지. 관광지명은 description에도 나열하거나 routeText와 맞출 것.
