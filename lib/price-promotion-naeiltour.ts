/**
 * 내일투어(naeiltour) 전용 — 상품 상단 가격·혜택·쿠폰 블록 (상세 페이지 DOM 우선, 복붙+Gemini 보완, preview/raw 보존).
 ...
 * @see lib/register-preview-ssot-hanatour.ts · lib/register-preview-ssot-modetour.ts · lib/register-preview-ssot-verygoodtour.ts · lib/register-preview-ssot-naeiltour.ts (미리보기 배지·문구, 공급사별)
 */
