/** [naeiltour] register-correction-preview */
/**
...
} from '@/lib/register-correction-types-naeiltour'
import { issueBadge } from '@/lib/register-preview-ssot-naeiltour'
import {
  buildSupplierFlightSnippet,
  mapIssueFieldToFlightKind,
} from '@/lib/register-flight-evidence-supplier-naeiltour'
...
/** `register-preview-ssot-naeiltour`의 issueBadge 와 동일 배지 산출 — 동일 공급사 모듈 내 헬퍼 */
