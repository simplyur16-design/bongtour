...
/**
 * 중국 탭 메가메뉴 행(browse `country` 슬러그) → DB country·Prisma 서브필터 키워드.
...
const CHINA_MEGA_BROWSE_ROWS: { label: string; countries: string[]; keywords: string[] }[] = [
  ...
  },
  {
    label: '정주',
    countries: ['중국'],
    keywords: ['정주', '정저우', 'zhengzhou', '소림사', '소림'],
  },
  {
    label: '낙양',
    countries: ['중국'],
    keywords: ['낙양', '뤄양', 'luoyang'],
  },
  {
    label: '개봉',
    countries: ['중국'],
    keywords: ['개봉', '카이펑', 'kaifeng'],
  },
  {
    label: '초작',
    countries: ['중국'],
    keywords: ['초작', '자오쭤', 'jiaozuo', '운대산', 'yuntaishan'],
  },
  {
    label: '화중',
    countries: ['중국'],
  ...
  },
  {
    label: '남경',
    countries: ['중국'],
    keywords: ['남경', 'nanjing', '南京'],
  },
  {
    label: '대동',
    countries: ['중국'],
    keywords: ['대동', 'datong', '大同'],
  },
  {
    label: '심양',
    countries: ['중국'],
    keywords: ['심양', 'shenyang', '沈阳'],
  },
  {
    label: '장백산',
    countries: ['중국'],
    keywords: ['장백산', '백두산', 'changbai', '장백'],
  },
  {
    label: '중경',
    countries: ['중국'],
    keywords: ['중경', 'chongqing', '충칭', '重庆'],
  },
  {
    label: '테를지',
    countries: ['몽골'],
    keywords: ['테를지', 'terelj', '몽골'],
  },
  {
    label: '내몽골',
    countries: ['중국'],
...
const BROWSE_COUNTRY_SLUG_TO_DB_COUNTRIES: Record<string, string[]> = {
  ...
  'western-europe': ['프랑스', '모나코', '스위스', '이탈리아', '영국', '독일', '네덜란드', '벨기에', '오스트리아'],
  'eastern-europe': ['동유럽'],
  'southern-europe': ['이탈리아', '스페인', '그리스', '포르투갈'],
  'northern-europe': ['북유럽'],
  서유럽: ['프랑스', '모나코', '스위스', '이탈리아', '영국', '독일', '네덜란드', '벨기에', '오스트리아'],
  동유럽: ['동유럽'],
  북유럽: ['북유럽'],
  'middle-east': ['튀르키예'],
  caucasus: [],
