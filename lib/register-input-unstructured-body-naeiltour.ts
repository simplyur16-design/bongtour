/** 롯데관광 등록 전용: 비정형 옵션·쇼핑 본문 휴리스틱. `register-input-parse-naeiltour`만 import. */
...
import { parseOptionalTourTableRowsFromRawText, parseShoppingStopsFromLines } from '@/lib/structured-tour-signals-naeiltour'
