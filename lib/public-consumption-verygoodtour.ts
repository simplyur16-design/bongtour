/**
 * 참좋은여행(verygoodtour) 전용 — 공개 상세 consumption resolution (선택관광·쇼핑·호텔 canonical / legacy 우선순위).
 *
 * 계약
 ...
 */
import { splitHotelNamesLine, type DayHotelPlan } from '@/lib/day-hotel-plans-verygoodtour'
