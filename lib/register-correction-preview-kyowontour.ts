/** [kyowontour] register-correction-preview */
/**
...
} from '@/lib/register-correction-types-kyowontour'
import { issueBadge } from '@/lib/register-preview-ssot-kyowontour'
import {
  buildSupplierFlightSnippet,
  mapIssueFieldToFlightKind,
} from '@/lib/register-flight-evidence-supplier-kyowontour'
...
/** `register-preview-ssot-kyowontour`의 issueBadge 와 동일 배지 산출 — 동일 공급사 모듈 내 헬퍼 */
