...
export const MAIN_HERO_AUX_LINK_HREF = '#season-curation-main'
...
export const MAIN_HERO_CTA_SECONDARY_LABEL = '문의하기'
...
export const MOBILE_STICKY_PHONE_LABEL = '전화'

export const MOBILE_STICKY_PHONE_HREF = 'tel:031-213-2558' as const

export const MOBILE_STICKY_KAKAO_LABEL = '카톡 상담'

export const MOBILE_STICKY_KAKAO_HREF = 'https://pf.kakao.com/_xlxjrxlX/chat' as const

export const MOBILE_STICKY_ESIM_LABEL = 'eSIM'

export const MOBILE_STICKY_ESIM_HREF = '/travel/esim' as const
