...
const KYOWONTOUR_DEPARTURE_COLLECTION_FLOW = [
  'detail_opened',
  'baseline_extracted',
  'departure_ui_opened',
  'date_clicked',
...
export function buildCommonMatchingTrace(payload: KyowontourTracePayload): string {
  return JSON.stringify(
    {
      flow: KYOWONTOUR_DEPARTURE_COLLECTION_FLOW,
      ...payload,
    },
    null,
    0
