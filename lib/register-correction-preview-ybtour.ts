/** [ybtour] register-correction-preview */
/**
...
import type { RegisterPreviewSsotMeta } from '@/lib/register-preview-ssot-ybtour'
...
} from '@/lib/register-correction-types-ybtour'
import { issueBadge } from '@/lib/register-preview-ssot-ybtour'
import {
...
/** `register-preview-ssot-ybtour`의 issueBadge 와 동일 배지 산출 — 동일 공급사 모듈 내 헬퍼 */
