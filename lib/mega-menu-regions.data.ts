...
const BUSAN_DEPARTURE: MegaMenuCountryGroupDef[] = [
  G(
    '동남아시아/대만/서남아',
    [
      L('타이베이', ['타이베이', '부산', '출발']),
      ...
      L('달랏', ['달랏', '부산', '출발']),
      L('나트랑', ['나트랑', '부산', '출발']),
      L('하노이/하롱베이', ['하노이', '하롱베이', '부산', '출발']),
      L('푸꾸옥', ['푸꾸옥', '부산', '출발']),
      L('사파', ['사파', '부산', '출발']),
      L('호치민/판티엣(무이네)', ['호치민', '판티엣', '무이네', '부산', '출발']),
      L('시엠립(앙코르와트)', ['시엠립', '앙코르와트', '부산', '출발']),
      L('라오스', ['라오스', '부산', '출발']),
      L('싱가포르', ['싱가포르', '부산', '출발']),
      L('코타키나발루', ['코타키나발루', '부산', '출발']),
      L('쿠알라룸푸르', ['쿠알라룸푸르', '부산', '출발']),
      L('발리', ['발리', '부산', '출발']),
    ],
    true,
  ),
  ...
  G(
    ...
    [
      L('대마도', ['대마도', '부산', '출발', '선박']),
      L('후쿠오카', ['후쿠오카', '부산', '출발', '선박']),
      L('시모노세키', ['시모노세키', '부산', '출발', '선박']),
      L('오사카', ['오사카', '부산', '출발', '선박']),
    ],
    true,
  ),
  ...
  G(
    ...
    [
      ...
      L('상해', ['상해', '부산', '출발']),
      L('백두산', ['백두산', '부산', '출발']),
      L('칭다오(청도)', ['칭다오', '청도', '부산', '출발']),
      L('계림/광저우', ['계림', '광저우', '부산', '출발']),
      L('천저우', ['천저우', '부산', '출발']),
      L('충칭(중경)', ['충칭', '중경', '부산', '출발']),
      L('하이난', ['하이난', '부산', '출발']),
      L('북경', ['북경', '부산', '출발']),
      ...
      L('황산', ['황산', '부산', '출발']),
      L('태항산', ['태항산', '부산', '출발']),
      L('몽골(울란바토르)', ['몽골', '울란바토르', '부산', '출발']),
      L('내몽골(오르도스, 호화호특)', ['내몽골', '오르도스', '호화호특', '부산', '출발']),
      L('쿤밍(곤명)', ['쿤밍', '곤명', '부산', '출발']),
      L('리장(여강)', ['리장', '여강', '부산', '출발']),
      L('사천성(성도/구채구)', ['사천성', '성도', '구채구', '부산', '출발']),
      L('카자흐스탄(알마티)', ['카자흐스탄', '알마티', '부산', '출발']),
      L('은시', ['은시', '부산', '출발']),
    ],
    true,
  ),
...
const CHEONGJU_DEPARTURE: MegaMenuCountryGroupDef[] = [
  G(
    '동남아시아/대만/서남아',
    [
      L('다낭', ['다낭', '청주', '출발']),
  ...
  G(
    ...
    [
      ...
      L('삿포로', ['삿포로', '청주', '출발']),
      L('나고야', ['나고야', '청주', '출발']),
      L('알메루트/마츠모토', ['알메루트', '마츠모토', '청주', '출발']),
      L('아키타/하나마키', ['아키타', '하나마키', '청주', '출발']),
    ],
    true,
  ),
  G(
    ...
    [
      L('장가계', ['장가계', '청주', '출발']),
      L('백두산', ['백두산', '청주', '출발']),
      L('내몽골(오르도스)', ['내몽골', '오르도스', '청주', '출발']),
      L('몽골', ['몽골', '청주', '출발']),
      L('상해', ['상해', '청주', '출발']),
      L('태항산', ['태항산', '청주', '출발']),
      L('귀주성(귀양)', ['귀주성', '귀양', '청주', '출발']),
      L('사천성(성도/구채구)', ['사천성', '성도', '구채구', '청주', '출발']),
      L('의창', ['의창', '청주', '출발']),
    ],
    true,
  ),
...
const DAEGU_DEPARTURE: MegaMenuCountryGroupDef[] = [
  G(
    '동남아시아/대만/서남아',
    [
      L('방콕', ['방콕', '대구', '출발']),
  ...
  G(
    ...
    [
      ...
      L('홍콩', ['홍콩', '대구', '출발']),
      L('백두산', ['백두산', '대구', '출발']),
      L('몽골(울란바토르)', ['몽골', '울란바토르', '대구', '출발']),
      L('내몽골(오르도스/호화호특)', ['내몽골', '오르도스', '호화호특', '대구', '출발']),
      L('계림', ['계림', '대구', '출발']),
      L('상해', ['상해', '대구', '출발']),
      L('황산', ['황산', '대구', '출발']),
      L('사천성(성도/구채구)', ['사천성', '성도', '구채구', '대구', '출발']),
      L('칭다오(청도)', ['칭다오', '청도', '대구', '출발']),
      L('은시', ['은시', '대구', '출발']),
    ],
    true,
  ),
...
/** 9탭 + 하단 특수 탭(unified-location-tree) — 순서 고정 */
export const MEGA_MENU_TAB_DEFINITIONS: MegaMenuTabDef[] = [
  ...
  { id: 'busan_dep', label: '부산출발', groups: BUSAN_DEPARTURE },
  { id: 'cheongju_dep', label: '청주출발', groups: CHEONGJU_DEPARTURE },
  { id: 'daegu_dep', label: '대구출발', groups: DAEGU_DEPARTURE },
]
