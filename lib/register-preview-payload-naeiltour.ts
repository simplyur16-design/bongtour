/** [naeiltour] register-preview-payload */
import type { DeparturePreviewRow } from '@/lib/departure-preview'
import type { PricePromotionFieldIssue, PricePromotionSnapshot } from '@/lib/price-promotion-naeiltour'
import type { RegisterExtractionFieldIssue } from '@/lib/register-llm-schema-naeiltour'
import type { DayHotelPlan } from '@/lib/day-hotel-plans-naeiltour'
import type { RegisterPreviewSsotMeta } from '@/lib/register-preview-ssot-naeiltour'
import type { DetailBodyParseSnapshot } from '@/lib/detail-body-parser'
import type { RegisterCorrectionPreviewV1 } from '@/lib/register-correction-types-naeiltour'
import type { RegisterVerificationV1 } from '@/lib/admin-register-verification-meta-naeiltour'
import type { NaeiltourFinalParsed } from '@/lib/naeiltour-admin-preview-card-types'
...
export type RegisterPreviewPayload<Parsed = unknown> = {
  ...
  data?: NaeiltourFinalParsed | null
}
