...
- schedule[].routeText: 그날 방문하는 장소를 본문 순서 그대로 ' - ' (공백-하이픈-공백)로 연결한 한 줄 경로. 예: JFK공항 - 뉴욕 - 덤보 - 브루클린브릿지(조망) - 뉴욕차이나타운(조망). 본문에 [조망], [차창관광], [외부관람], [선택관광] 태그가 있으면 (조망), (차창), (외부관람), (선택관광)로 괄호 안에 보존. 공항/호텔/식당도 방문 장소면 포함. 본문에 없는 장소를 만들지 말 것. 빈 일정이면 null.`
