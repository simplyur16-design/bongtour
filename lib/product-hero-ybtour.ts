 ...
 * 히어로 출발·귀국 표시는 구조화 본문(ybtourFlightStructured)보다 이쪽만 쓴다(날짜·귀국 혼선 방지).
 */
 ...
 *
 * `disableFlightStructuredFallback`: true면 상품 본문 `ybtourFlightStructured`를 쓰지 않는다(출발 행·`departureKeyFactsByDate`만 SSOT).
 */
