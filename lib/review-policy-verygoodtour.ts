/**
 * 참좋은여행(verygoodtour) 등록 전용: detail review 집계 + 쇼핑 Gemini 노이즈 필터.
 */
import type {
...
export function buildDetailReviewPolicyVerygoodtour(args: {
  ...
  const bk = canonicalBrandKeyForRegister('verygoodtour')
