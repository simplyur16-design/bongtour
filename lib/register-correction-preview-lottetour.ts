/** [lottetour] register-correction-preview */
/**
...
} from '@/lib/register-correction-types-lottetour'
import { issueBadge } from '@/lib/register-preview-ssot-lottetour'
import {
  buildSupplierFlightSnippet,
  mapIssueFieldToFlightKind,
} from '@/lib/register-flight-evidence-supplier-lottetour'
...
/** `register-preview-ssot-lottetour`의 issueBadge 와 동일 배지 산출 — 동일 공급사 모듈 내 헬퍼 */
