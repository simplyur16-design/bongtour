/**
 * 하나투어 출발옵션 — 제목 레이어·matchingTraceRaw 직렬화 (전용).
 * 이전 공용 출발옵션 모듈에서 분리.
 */
...
const HANATOUR_DEPARTURE_COLLECTION_FLOW = [
  'detail_opened',
  'baseline_extracted',
  'departure_ui_opened',
  'date_clicked',
...
export function buildCommonMatchingTrace(payload: HanatourTracePayload): string {
  return JSON.stringify(
    {
      flow: HANATOUR_DEPARTURE_COLLECTION_FLOW,
      ...payload,
    },
    null,
    0
