/**
 * 내일투어 전용: prices[] 비어 있을 때 최소 ProductDeparture 1행 합성.
 */
import type { RegisterParsed } from '@/lib/register-llm-schema-naeiltour'
import { parseDepartureDateTime, type DepartureInput } from '@/lib/upsert-product-departures-naeiltour'
...
export function naeiltourBuildMinimalDepartureInputs(
  tripStartIso: string,
