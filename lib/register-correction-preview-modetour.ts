...
import type { RegisterPreviewProductDraft } from '@/lib/register-preview-payload-modetour'
import {
...
} from '@/lib/register-correction-types-modetour'
import { issueBadge } from '@/lib/register-preview-ssot-modetour'
import {
...
/** `register-preview-ssot-modetour`의 issueBadge 와 동일 배지 산출 — 동일 공급사 모듈 내 헬퍼 */
