...
export type RegisterParsed = {
  ...
  /** 상품 핵심 포인트 원문(상품 POINT / KeyPointInfo) */
  ...
  /** 내부: B2C+HTML 상세카드 자동수집(미리보기 adapterPrefetchRan) */
  modetourDetailCollectRan?: boolean
  modetourDetailCollectSummary?: string | null
}
...
export type RegisterLlmParseOptionsCommon = {
  ...
  /** 관리자 등록 UI travelScope — air_hotel_free(항공+호텔·자유여행) vs 패키지 */
