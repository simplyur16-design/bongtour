/**
 * 노랑풍선 전용: prices[] 비어 있을 때 최소 ProductDeparture 1행 합성.
 */
import type { RegisterParsed } from '@/lib/register-llm-schema-ybtour'
import { parseDepartureDateTime, type DepartureInput } from '@/lib/upsert-product-departures-ybtour'
...
export function ybtourBuildMinimalDepartureInputs(
  tripStartIso: string,
