/**
 * 하나투어(hanatour) 등록 전용: detail review 집계 + 쇼핑 Gemini 노이즈 필터.
 */
import type {
...
export function buildDetailReviewPolicyHanatour(args: {
  ...
  const bk = canonicalBrandKeyForRegister('hanatour')
