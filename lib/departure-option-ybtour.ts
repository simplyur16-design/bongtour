/**
 * 노랑풍선(ybtour) 출발옵션 — 제목 레이어·matchingTraceRaw (전용).
 * 이전 공용 출발옵션 모듈에서 분리.
 */
...
const YBTOUR_DEPARTURE_COLLECTION_FLOW = [
  'detail_opened',
  'baseline_extracted',
  'departure_ui_opened',
  'date_clicked',
...
export function buildCommonMatchingTrace(payload: YbtourTracePayload): string {
  return JSON.stringify(
    {
      flow: YBTOUR_DEPARTURE_COLLECTION_FLOW,
      ...payload,
    },
    null,
    0
