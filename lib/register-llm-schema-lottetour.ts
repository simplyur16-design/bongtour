...
export type LottetourHotelListRow = { city: string; name: string; status: '확정' | '미정' }
export type LottetourMeetingInfo = { location: string; time?: string | null }
export type LottetourTourLeader = {
  available?: boolean
  feeRaw?: string | null
...
export type RegisterGeminiLlmJson = Record<string, unknown> & {
  ...
  godId?: string
  evtCd?: string | null
  categoryMenuNo?: LottetourCategoryMenuNo | null
  hotelList?: LottetourHotelListRow[]
  seatUpgradeOptions?: string[]
  meetingInfo?: LottetourMeetingInfo | null
  tourLeader?: LottetourTourLeader | null
  title?: string
  destination?: string
  duration?: string
  airline?: string | null
...
export type RegisterParsed = {
  ...
  categoryMenuNo?: LottetourCategoryMenuNo | null
  /** 도시별 예정 숙박 후보(미정/확정) */
  hotelList?: LottetourHotelListRow[] | null
  /** 좌석 승급 옵션 원문 줄 */
  seatUpgradeOptions?: string[] | null
  /** 미팅 장소·시각 구조화 */
  meetingInfo?: LottetourMeetingInfo | null
  /** 인솔자 동반·경비 안내 */
  tourLeader?: LottetourTourLeader | null
