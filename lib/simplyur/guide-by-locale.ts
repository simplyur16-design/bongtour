...
import { GUIDE_EN_HANDOFF } from "@/lib/simplyur/guide-content/handoff-en";
...
const GUIDE_BY_LOCALE: Partial<Record<SimplyurLocale, SimplyurGuideMessages>> = {
  ja: {
    ...
    commonFaq: [
      ...
      { q: "料金表示", a: "カタログ価格×1.10を各言語の通貨で表示。" },
  ...
  "zh-TW": {
    ...
    commonFaq: [
      ...
      { q: "價格", a: "目錄價×1.10，依語言顯示幣別。優惠券不支援。" },
  ...
  vi: {
    ...
    commonFaq: [
      ...
      { q: "Giá", a: "Giá catalog ×1.10, quy đổi theo ngôn ngữ. Không coupon." },
