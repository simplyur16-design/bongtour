...
export const SCHEDULE_SPOT_KO_REGEX_RULES: ReadonlyArray<{ re: RegExp; en: string }> = [
  ...
  { re: /(?<!다낭.{0,48})산토리니|(?<!Da\s*Nang.{0,48})Santorini/iu, en: "Santorini caldera blue domes" },
  ...
  { re: /마사이\s*부족|Maasai\s*village|마사이\s*마을/i, en: "Maasai village Tanzania" },
  { re: /볼더스\s*비치|Boulders\s*Beach/i, en: "Boulders Beach penguins Cape Town" },
  { re: /희망봉|Cape\s*of\s*Good\s*Hope/i, en: "Cape of Good Hope South Africa" },
  { re: /케이프\s*포인트|Cape\s*Point/i, en: "Cape Point South Africa" },
  { re: /채프먼스|Chapman'?s?\s*Peak/i, en: "Chapmans Peak Drive Cape Town" },
  { re: /커스텐보쉬|Kirstenbosch/i, en: "Kirstenbosch Botanical Garden Cape Town" },
  { re: /보캅|Bo-?Kaap/i, en: "Bo-Kaap Cape Town" },
  ...
  { re: /가버먼트\s*가든|Government\s*Gardens|식민지\s*시대\s*관청|식민지시대\s*관청/i, en: "Government Gardens Rotorua" },
  { re: /알칼리성\s*염화\s*온천|폴리네시안\s*스파|Polynesian\s*Spa/i, en: "Polynesian Spa Rotorua" },
  { re: /시그나기|Signagi/i, en: "Signagi Georgia wine town" },
  { re: /보드베|Bodbe/i, en: "Bodbe Monastery Georgia" },
  { re: /므츠헤타|Mtskheta/i, en: "Mtskheta Georgia ancient capital" },
  { re: /아나누리|Ananuri/i, en: "Ananuri Fortress Georgia" },
  { re: /즈바리|Jvari/i, en: "Jvari Monastery Mtskheta" },
  { re: /스베티츠호벨리|Svetitskhoveli/i, en: "Svetitskhoveli Cathedral Mtskheta" },
  { re: /조이\s*아일랜드|Joy\s*Island/i, en: "Maldives Joy Island lagoon villa" },
  { re: /오버워터\s*빌라|overwater\s*(?:villa|bungalow)/i, en: "Maldives overwater bungalow resort" },
  { re: /바스타키아|Bastakiya|알\s*파히디|Al\s*Fahidi/i, en: "Al Fahidi Historical Dubai" },
  ...
  { re: /홍콩\s*고궁\s*박물관|Hong\s*Kong\s*Palace\s*Museum/i, en: "Hong Kong Palace Museum" },
  { re: /국립\s*고궁\s*박물관|National\s*Palace\s*Museum(?:\s*Taipei)?/i, en: "National Palace Museum Taipei" },
  ...
  { re: /데린쿠유|데린구유|지하\s*도시|Derinkuyu/i, en: "Derinkuyu Underground City Cappadocia" },
  { re: /메블라나|메블라냐|Mevlana/i, en: 'Mevlana Museum Konya' },
  { re: /콘야|Konya/i, en: 'Konya Turkey' },
  { re: /아피온|Afyon/i, en: 'Afyonkarahisar Turkey' },
  ...
  { re: /응고롱고(?:로)?|Ngorongoro/i, en: "Ngorongoro Crater Tanzania wildlife" },
  ...
  { re: /마나도|Manado/i, en: "Manado" },
  // REGRESSION-FREEZE[schedule-poi-regex-ssot]: ModeTour AIP102 Manado day-route POI — bare city≠Jesus/Siladen — manifest
  { re: /부나켄|Bunaken/i, en: "Bunaken National Marine Park" },
  { re: /실라덴|Siladen/i, en: "Siladen Island" },
  { re: /통코|Tangkoko/i, en: "Tangkoko Nature Reserve" },
  { re: /토모혼|Tomohon/i, en: "Tomohon Colorful Market" },
  ...
  { re: /테오티와칸|테오티우아칸|Teotihuacan/i, en: "Teotihuacan pyramids Mexico ancient ruins" },
  ...
  { re: /마르세유|Marseille/i, en: "Marseille Old Port" },
  { re: /보클뤼즈|퐁텐\s*드\s*보클뤼즈|Fontaine\s*de\s*Vaucluse|\bVaucluse\b/i, en: "Fontaine de Vaucluse" },
  { re: /엑상\s*프로방스|엑상프로방스|Aix[- ]?en[- ]?Provence/i, en: "Aix en Provence Cours Mirabeau" },
  ...
  { re: /보르도\s*부르스|부르스\s*광장|Place\s*de\s*la\s*Bourse|피에르\s*다리/i, en: "Place de la Bourse Bordeaux" },
  { re: /그랑\s*테아트르|Grand\s*Th[eé][aâ]tre/i, en: "Grand Theatre Bordeaux" },
  { re: /그로스\s*클로슈|Grosse\s*Cloche/i, en: "Grosse Cloche Bordeaux" },
  { re: /보르도\s*대성당/i, en: "Bordeaux Cathedral Saint Andre" },
  // REGRESSION-FREEZE[register-pre-photo-empty-middle-is-free-day]: 포르트 카이요 ≠ Cairo — manifest
  { re: /포르트\s*카이요|Porte\s*Cailhau/i, en: 'Porte Cailhau Bordeaux' },
  ...
  { re: /마세나\s*광장|Place\s*Mass[eé]na/i, en: "Place Massena Nice" },
  { re: /아를\s*구시가|아를\s*원형|아를\s*투우|(?:^|[\s\-·,/])아를(?:$|[\s\-·,/])|(?<![A-Za-z])Arles(?![A-Za-z])/i, en: "Arles Amphitheatre Provence" },
  { re: /아비뇽\s*다리|Pont\s*(?:d['’])?Avignon|Saint[\s-]*B[eé]n[eé]zet/i, en: "Pont d Avignon" },
  { re: /그랑\s*카지노|그랜드\s*카지노|Grand\s*Casino/i, en: "Monte Carlo Casino Monaco" },
  ...
  { re: /알가르베|Algarve/i, en: "Benagil Cave Algarve" },
  { re: /알부페이라|Albufeira/i, en: "Albufeira Algarve beach Portugal" },
  { re: /(?<![가-힣])라고스(?![가-힣])|\bLagos\b/i, en: "Lagos Algarve Portugal old town" },
  { re: /사그레스|Sagres/i, en: "Sagres fortress Portugal" },
  { re: /상비센테\s*곶|Cape\s*St\.?\s*Vincent|Cabo\s*S[aã]o\s*Vicente/i, en: "Cape St Vincent Portugal" },
  ...
  { re: /자이언\s*(?:캐년|국립\s*공원)|Zion\s*(?:National\s*)?Park/i, en: "Zion National Park" },
  ...
  { re: /(?:유|우)니버설\s*스튜디오\s*(?:재팬|japan)|(?:유|우)니버셜\s*스튜디오\s*(?:재팬|japan)|USJ/iu, en: "Universal Studios Japan Osaka" },
  // bare 유니버설 → Japan 금지: 일본·오사카·도쿄 맥락 있을 때만 USJ
  { re: /(?:오사카|도쿄|일본|japan|osaka|tokyo|재팬).{0,32}(?:유|우)니버[설셜]|(?:유|우)니버[설셜].{0,32}(?:오사카|도쿄|일본|재팬|japan|osaka)/iu, en: "Universal Studios Japan Osaka" },
  ...
  { re: /가미코치|카미코지|Kamikochi/i, en: 'Kamikochi Japan Alps valley' },
  { re: /구로베\s*협곡|토롯코|Kurobe\s*Gorge|Torokko/i, en: 'Kurobe Gorge Torokko Train' },
  { re: /고치성|Kochi\s*Castle/i, en: 'Kochi Castle Japan' },
  { re: /마키노\s*식물원|Makino/i, en: 'Makino Botanical Garden Kochi' },
  { re: /카츠라하마|Katsurahama/i, en: 'Katsurahama Beach Kochi' },
  { re: /버킹엄\s*궁전|Buckingham\s*Palace/i, en: 'Buckingham Palace London' },
  { re: /대영\s*박물관|British\s*Museum/i, en: 'British Museum London' },
  { re: /타워\s*브리지|Tower\s*Bridge/i, en: 'Tower Bridge London Thames' },
  { re: /더\s*샤드|The\s*Shard|\bShard\b/i, en: 'The Shard London skyline' },
  { re: /사크레\s*쾨르|사크레쾨르|Sacr[eé]\s*[Cc]oeur/i, en: 'Sacre Coeur Basilica Paris' },
  { re: /마레\s*지구|Le\s*Marais/i, en: 'Le Marais Paris district' },
  { re: /MSG\s*스피어|스피어|Sphere\s*Las\s*Vegas/i, en: 'MSG Sphere Las Vegas' },
  { re: /벨라지오\s*분수|Bellagio\s*Fountain/i, en: 'Bellagio Fountains Las Vegas' },
  { re: /벨라지오\s*보태니컬|Bellagio\s*Conservatory|Bellagio\s*Botanical/i, en: 'Bellagio Conservatory Las Vegas' },
  { re: /프리몬트|Fremont\s*Street/i, en: 'Fremont Street Experience Las Vegas' },
  { re: /세븐\s*매직\s*마운틴|Seven\s*Magic\s*Mountains/i, en: 'Seven Magic Mountains Las Vegas' },
  { re: /레드락|Red\s*Rock\s*Canyon/i, en: 'Red Rock Canyon Nevada' },
  { re: /금문교|Golden\s*Gate/i, en: 'Golden Gate Bridge San Francisco' },
  { re: /피어\s*39|Pier\s*39/i, en: 'Pier 39 San Francisco' },
  { re: /피셔맨스?\s*워프|Fisherman'?s?\s*Wharf/i, en: 'Fishermans Wharf San Francisco' },
  { re: /헐리우드\s*명예의\s*거리|Walk\s*of\s*Fame/i, en: 'Hollywood Walk of Fame Los Angeles' },
  { re: /아카마\s*신궁|Akama/i, en: 'Akama Shrine Shimonoseki' },
  { re: /간몬\s*해저|Kanmon/i, en: 'Kanmon Tunnel Shimonoseki' },
  { re: /모지코|Mojiko/i, en: 'Mojiko Retro town Kitakyushu' },
  { re: /탄탈루스|Tantalus/i, en: 'Tantalus Lookout Honolulu' },
  { re: /오차드\s*로드|Orchard\s*Road/i, en: 'Orchard Road Singapore' },
  { re: /불아사|Buddha\s*Tooth/i, en: 'Buddha Tooth Relic Temple Singapore' },
  { re: /쿠로가와|Kurokawa/i, en: 'Kurokawa Onsen village Kumamoto' },
  { re: /쿠마모토성|Kumamoto\s*Castle/i, en: 'Kumamoto Castle Japan' },
  { re: /쇼도시마|Shodoshima/i, en: 'Shodoshima olive park Japan' },
  ...
  { re: /알렉산드리아\s*도서관|Bibliotheca\s*Alexandrina/i, en: 'Bibliotheca Alexandrina Egypt' },
  { re: /카이트베이|Qaitbay|Citadel\s*of\s*Qaitbay/i, en: 'Qaitbay Citadel Alexandria' },
  { re: /몬타자\s*궁전|Montaza\s*Palace/i, en: 'Montaza Palace Alexandria' },
  { re: /알렉산드리아|Alexandria/i, en: 'Alexandria Egypt Mediterranean' },
  { re: /카일루아|Kailua\s*Beach/i, en: 'Kailua Beach Park Oahu' },
  { re: /라니카이|Lanikai/i, en: 'Lanikai Beach Oahu' },
  { re: /스카이\s*가든|Sky\s*Garden/i, en: 'Sky Garden London' },
  { re: /코벤트\s*가든|Covent\s*Garden/i, en: 'Covent Garden London' },
  ...
  // REGRESSION-FREEZE[schedule-poi-regex-ssot]: 빈 중간일 한·영 POI — Chichen Itza·Taormina — manifest
  { re: /치첸이사|Chichen\s*Itza/i, en: 'Chichen Itza' },
  { re: /타오르미나|Taormina/i, en: 'Taormina Sicily old town' },
  { re: /사보카|Savoca/i, en: 'Savoca Sicily village' },
  { re: /아그리젠토|Agrigento/i, en: 'Agrigento Valley of the Temples' },
  { re: /체팔루|Cefalu/i, en: 'Cefalu Sicily cathedral' },
  { re: /팔레르모|Palermo/i, en: 'Palermo Sicily old town' },
  { re: /그단스크|Gdansk|Gdańsk/i, en: 'Gdansk Old Town' },
  { re: /소포트|Sopot/i, en: 'Sopot Baltic beach' },
  { re: /말보르크|Malbork/i, en: 'Malbork Castle' },
  { re: /토룬|Torun|Toruń/i, en: 'Torun medieval old town' },
  { re: /포즈난|Poznan|Poznań/i, en: 'Poznan old town square' },
  { re: /브로츠와프|Wroclaw|Wrocław/i, en: 'Wroclaw market square' },
  { re: /그랜드월드|Grand\s*World/i, en: 'Grand World Phu Quoc' },
  { re: /소나씨\s*야시장|Sonasea/i, en: 'Sonasea Night Market Phu Quoc' },
  { re: /이집트\s*대박물관|그랜드\s*이집션|Grand\s*Egyptian|\bGEM\b/i, en: 'Grand Egyptian Museum' },
  { re: /칸\s*엘\s*칼릴리|칸엘칼릴리|Khan\s*el[- ]?Khalili/i, en: 'Khan el Khalili bazaar' },
  { re: /스트랫퍼드|스트랫포드|Stratford[- ]upon[- ]Avon/i, en: 'Stratford-upon-Avon Shakespeare' },
  { re: /코헴|Cochem/i, en: 'Cochem Castle Moselle' },
  { re: /트리어|Trier/i, en: 'Trier Porta Nigra' },
  { re: /브뤼헤|브뤼주|Bruges/i, en: 'Bruges canals old town' },
  { re: /열트산|Turtle\s*Rock/i, en: 'Turtle Rock Terelj' },
  { re: /아리야\s*사원|아리야발|Aryabal/i, en: 'Aryabal Temple Terelj' },
  // REGRESSION-FREEZE[register-pre-photo-heal-blocked-refill]: 울란바토르·칭기스칸광장·생노민 — manifest
  { re: /울란바토르|Ulaanbaatar|Ulan\s*Bator/i, en: 'Ulaanbaatar' },
  { re: /칭기스칸\s*광장|칭기즈칸\s*광장|Sukhbaatar\s*Square/i, en: 'Sukhbaatar Square Ulaanbaatar' },
  { re: /생노민\s*사원|간단\s*사원|Gandantegchinlen/i, en: 'Gandantegchinlen Monastery Ulaanbaatar' },
  { re: /자이승\s*승전탑|자이승|Zaisan/i, en: 'Zaisan Memorial Ulaanbaatar' },
  { re: /에트나|Etna/i, en: 'Mount Etna volcano' },
  { re: /시라쿠사|Syracuse/i, en: 'Syracuse Sicily island' },
  { re: /고조(?:섬)?|Gozo/i, en: 'Gozo island Malta' },
  { re: /카타니아|Catania/i, en: 'Catania Mount Etna view' },
  { re: /스윈던|Swindon/i, en: 'Stonehenge Salisbury Plain' },
  { re: /72번\s*국도|Kamehameha\s*Highway/i, en: 'Kahuku Hawaii coast' },
  ...
  { re: /엘젬|El\s*Jem/i, en: 'El Jem amphitheatre Tunisia' },
  { re: /스팍스|Sfax/i, en: 'Sfax Tunisia medina' },
  { re: /(?:^|[\s-])수스(?:[\s-]|$)|Sousse/i, en: 'Sousse medina Tunisia' },
  { re: /다합|Dahab/i, en: 'Dahab Egypt Red Sea' },
  { re: /수이젠지|조쥬엔|조사이엔|Suizenji/i, en: 'Suizenji Jojuen garden Kumamoto' },
  { re: /사반지\s*사원|Sabanci/i, en: 'Sabanci Central Mosque Adana' },
  { re: /테렐지초원|테렐지\s*초원/i, en: 'Terelj National Park' },
  { re: /두가|Dougga/i, en: 'Dougga Roman ruins' },
  { re: /카이로우안|Kairouan/i, en: 'Kairouan Grand Mosque' },
  { re: /고부스탄|Gobustan/i, en: 'Gobustan mud volcanoes' },
  { re: /셰키|Sheki/i, en: 'Sheki Khan Palace' },
  { re: /카후쿠|Kahuku/i, en: 'Kahuku Hawaii coast' },
  { re: /이올라니|Iolani/i, en: 'Iolani Palace Honolulu' },
  { re: /골든\s*서클|GOLDEN\s*CIRCLE/i, en: 'Golden Circle Iceland' },
  { re: /요쿨살론|Jokulsarlon|Jökulsárlón/i, en: 'Jokulsarlon glacier lagoon' },
  { re: /THE\s*BROAD|더\s*브로드/i, en: 'The Broad Museum Los Angeles' },
  { re: /라구사|Ragusa/i, en: 'Ragusa Sicily old town' },
  ...
  { re: /아나케나|Anakena/i, en: 'Anakena Beach Easter Island' },
  { re: /오롱고|Orongo/i, en: 'Orongo Easter Island crater' },
  { re: /모아이|Moai/i, en: 'Easter Island Moai statues' },
  { re: /히로사키|Hirosaki/i, en: 'Hirosaki Castle apple park' },
  { re: /와랏세|Warasse|네부타/i, en: 'Warasse Nebuta Festival Aomori' },
  { re: /아오모리|Aomori/i, en: 'Aomori Nebuta Museum' },
  { re: /아키타|Akita/i, en: 'Akita Japan castle town' },
  { re: /연태|Yantai|옌타이/i, en: 'Yantai Mountain park lighthouse' },
  { re: /펑라이|Penglai|봉래/i, en: 'Penglai Pavilion Yantai' },
  { re: /리펄스\s*베이|Repulse\s*Bay/i, en: 'Repulse Bay Hong Kong beach' },
  { re: /스탠리\s*마켓|Stanley\s*Market/i, en: 'Stanley Market Hong Kong' },
  { re: /초이홍|Choi\s*Hung/i, en: 'Choi Hung Estate rainbow Hong Kong' },
  { re: /익청\s*빌딩|Monster\s*Building/i, en: 'Monster Building Hong Kong' },
  { re: /카멜리아\s*힐|Camellia\s*Hill/i, en: 'Camellia Hill Jeju garden' },
  { re: /산방산|Sanbangsan/i, en: 'Sanbangsan Mountain Jeju' },
  { re: /송악산|Songaksan/i, en: 'Songaksan Coastal Trail Jeju' },
  { re: /밀\s*콜로나다|Mill\s*Colonnade/i, en: 'Mill Colonnade Karlovy Vary' },
  { re: /디아나\s*전망대|Diana\s*(?:Lookout|Tower)/i, en: 'Diana Lookout Karlovy Vary' },
  { re: /베헤로브카|Becherovka/i, en: 'Becherovka Museum Karlovy Vary' },
  { re: /뷔르츠부르크\s*레지덴츠|Wurzburg\s*Residence|Würzburg\s*Residence/i, en: 'Wurzburg Residence palace' },
  { re: /마리엔베르크|Marienberg/i, en: 'Marienberg Fortress Wurzburg' },
  { re: /쑤언흐엉|Xuan\s*Huong/i, en: 'Xuan Huong Lake Da Lat' },
  { re: /린푸옥|Linh\s*Phuoc/i, en: 'Linh Phuoc Pagoda Da Lat' },
  { re: /혼총|Hon\s*Chong/i, en: 'Hon Chong Cape Da Lat' },
  { re: /달랏|Da\s*Lat/i, en: 'Da Lat Vietnam highland city' },
  { re: /호루스\s*신전|Temple\s*of\s*Horus|Edfu/i, en: 'Temple of Horus Edfu' },
  { re: /잘츠카머구트|짤츠캄머굿|Salzkammergut/i, en: 'Salzkammergut lake' },
  { re: /자코파네|Zakopane/i, en: 'Zakopane Tatra mountains' },
  { re: /비엘리치카|Wieliczka/i, en: 'Wieliczka Salt Mine' },
  { re: /카카오코|Kakaako/i, en: 'Kakaako street art murals' },
  { re: /다이아몬드\s*헤드|Diamond\s*Head/i, en: 'Diamond Head crater' },
  { re: /키즈미에즈|카지미에시|Kazimierz\s*Dolny/i, en: 'Kazimierz Dolny old town' },
  { re: /루블린|Lublin/i, en: 'Lublin old town castle' },
  { re: /우치사르|Uchisar/i, en: 'Uchisar Castle Cappadocia' },
  { re: /히에라폴리스|Hierapolis/i, en: 'Hierapolis Pamukkale' },
  { re: /핫셉수트|합셉수트|Hatshepsut/i, en: 'Hatshepsut Temple' },
  { re: /멤논의\s*거상|Colossi\s*of\s*Memnon/i, en: 'Colossi of Memnon' },
  { re: /와디럼|Wadi\s*Rum/i, en: 'Wadi Rum desert' },
  { re: /암만\s*로마|로마원형극장/i, en: 'Amman Roman Theatre' },
  { re: /포잘|포짤|Pozzallo/i, en: 'Pozzallo Sicily harbour' },
  { re: /슬리에마|Sliema/i, en: 'Sliema Malta promenade' },
  { re: /마샤슬록|Marsaxlokk/i, en: 'Marsaxlokk Malta fishing harbour' },
  { re: /크렌디|Qrendi/i, en: 'Qrendi Malta prehistoric temples' },
  { re: /블루라군|Blue\s*Lagoon/i, en: 'Blue Lagoon Iceland' },
  { re: /그린다빅|Grindavik/i, en: 'Blue Lagoon Iceland' },
  { re: /캘리코\s*은광촌|Calico\s*Ghost/i, en: 'Calico Ghost Town California' },
  { re: /(?:^|[\s\-])기자(?:[\s\-]|$)|Giza\s*Pyramids|기자의\s*피라미드/i, en: 'Giza Pyramids' },
  { re: /템펠리아우키오|Temppeliaukio/i, en: 'Temppeliaukio Church Helsinki' },
  { re: /니하운|Nyhavn/i, en: 'Nyhavn Copenhagen harbour' },
  { re: /피르스트|First\s*Cliff/i, en: 'First Cliff Walk Grindelwald' },
  { re: /그린델발트|Grindelwald/i, en: 'Grindelwald First Swiss Alps' },
  { re: /퐁뒤가르|Pont\s*du\s*Gard/i, en: 'Pont du Gard aqueduct' },
  { re: /아비뇽|Avignon/i, en: 'Palais des Papes Avignon' },
  { re: /카시스|Cassis/i, en: 'Cassis Calanques cliffs' },
  { re: /고르드|Gordes/i, en: 'Gordes Provence hill village' },
  { re: /베르동|Verdon/i, en: 'Verdon Gorge Provence' },
  { re: /와일루아\s*폭포|Wailua\s*Falls/i, en: 'Wailua Falls Kauai' },
  { re: /마카푸|Makapuu/i, en: 'Makapuu Point lighthouse Oahu' },
  { re: /게그하드|Geghard/i, en: 'Geghard Monastery Armenia' },
  { re: /카즈베기|Kazbegi|Stepantsminda/i, en: 'Kazbegi Gergeti Trinity Church' },
  { re: /구다우리|Gudauri/i, en: 'Gudauri Caucasus mountains' },
  { re: /사다클|Sadakhlo/i, en: 'Sevan Lake Armenia' },
  { re: /세반|Lake\s*Sevan/i, en: 'Sevan Lake Armenia' },
  { re: /예레반|Yerevan/i, en: 'Yerevan Cascade Armenia' },
  { re: /트빌리시|Tbilisi/i, en: 'Tbilisi old town Narikala' },
  { re: /물의\s*거울|Miroir\s*d['’]?eau/i, en: 'Miroir d eau Bordeaux' },
  { re: /시테\s*뒤\s*뱅|Cite\s*du\s*Vin/i, en: 'Cite du Vin Bordeaux' },
  { re: /생떼밀리옹|Saint[- ]?Emilion|St[- ]?Emilion/i, en: 'Saint Emilion vineyards' },
  { re: /샹보르|Chambord/i, en: 'Chateau de Chambord Loire' },
  { re: /하지\s*래인|Haji\s*Lane/i, en: 'Haji Lane Singapore' },
  { re: /올드\s*힐\s*스트리트|Old\s*Hill\s*Street/i, en: 'Old Hill Street Police Station Singapore' },
  { re: /소깔로|소칼로|Zocalo/i, en: 'Zocalo Mexico City' },
  { re: /모네다\s*궁전|La\s*Moneda/i, en: 'La Moneda Palace Santiago' },
  { re: /아르마스\s*광장|Plaza\s*de\s*Armas/i, en: 'Plaza de Armas Santiago' },
  { re: /우루밤바|Urubamba/i, en: 'Urubamba Sacred Valley Peru' },
  { re: /룩셈부르크|Luxembourg/i, en: 'Luxembourg old town fortifications' },
  { re: /브뤼셀|Brussels/i, en: 'Grand Place Brussels' },
  { re: /쾰른|Cologne|Koln/i, en: 'Cologne Cathedral' },
  ...
  { re: /카피올라니|Kapiolani/i, en: 'Kapiolani Park Honolulu' },
  ...
  { re: /다테야마|알펜루트|Tateyama|Alpine\s*Route/i, en: 'Tateyama Kurobe Alpine Route' },
  { re: /우미\s*지옥|Umi\s*Jigoku/i, en: 'Umi Jigoku Beppu' },
  { re: /하모니랜드|Harmonyland/i, en: 'Sanrio Harmonyland' },
  { re: /레이니스피야라|Reynisfjara/i, en: 'Reynisfjara black sand beach' },
  { re: /디르홀레이|Dyrholaey/i, en: 'Dyrholaey Iceland arch' },
  { re: /그린다비크|Grindavik/i, en: 'Blue Lagoon Iceland' },
  { re: /(?:^|[\s\-])비크(?:[\s\-]|$)|Vik\s*Iceland/i, en: 'Reynisfjara black sand beach' },
  { re: /발\s*도르차|Val\s*d['’]?Orcia/i, en: 'Val d Orcia Tuscany hills' },
  { re: /몬테카티니|Montecatini/i, en: 'Montecatini Terme Tuscany' },
  { re: /태항산|Taihang/i, en: 'Taihang Mountains canyon' },
  { re: /석판암|Shiban/i, en: 'Shiban Rock Taihang canyon' },
  { re: /보천대협곡|Baotiantiangou/i, en: 'Taihang Mountains canyon' },
  ...
  { re: /천계산|Tianti/i, en: 'Tianji Mountain Taihang' },
  { re: /바토\s*파리지앵|Bateaux\s*Parisiens/i, en: 'Seine river cruise Paris' },
  { re: /바나산|Ba\s*Na(?:\s*Hills)?/i, en: 'Golden Bridge Da Nang' },
  { re: /알라모아나|Ala\s*Moana/i, en: 'Ala Moana Beach Park' },
  ...
  // REGRESSION-FREEZE[register-pre-photo-heal-blocked-refill]: 가오슝·컨딩·타이난·리장 — manifest
  { re: /어롼비\s*등대|Eluanbi|鵝鑾鼻/i, en: 'Eluanbi Lighthouse Kenting Taiwan' },
  { re: /용반\s*공원|Longpan|龍磐/i, en: 'Longpan Park Kenting Taiwan coast' },
  { re: /연지담|Maobitou|貓鼻頭/i, en: 'Maobitou Kenting Taiwan coast' },
  { re: /용호탑|Dragon\s*and\s*Tiger\s*Pagoda|龍虎塔/i, en: 'Dragon Tiger Pagoda Kaohsiung' },
  { re: /육합\s*야시장|Liuhe\s*Night\s*Market|六合/i, en: 'Liuhe Night Market Kaohsiung' },
  { re: /컨딩|Kenting|墾丁/i, en: 'Kenting National Park Taiwan coast' },
  { re: /가오슝|Kaohsiung|高雄/i, en: 'Kaohsiung Harbor Taiwan' },
  { re: /안평\s*고보|Anping\s*Fort|安平古堡/i, en: 'Anping Fort Tainan Taiwan' },
  { re: /적감루|Chihkan|赤崁樓/i, en: 'Chihkan Tower Tainan Taiwan' },
  { re: /스차오\s*녹색\s*터널|Sicao|四草/i, en: 'Sicao Green Tunnel Tainan Taiwan' },
  { re: /타이난|Tainan|台南/i, en: 'Tainan Confucius Temple Taiwan' },
  { re: /호도협|Tiger\s*Leaping\s*Gorge|虎跳峡/i, en: 'Tiger Leaping Gorge Yunnan' },
  { re: /샹그릴라\s*고성|Shangri[- ]?La\s*Old\s*Town/i, en: 'Shangri-La Old Town Yunnan' },
  { re: /샹그릴라|Shangri[- ]?La|香格里拉/i, en: 'Shangri-La Yunnan mountains' },
  { re: /송찬림사|Songzanlin|松赞林/i, en: 'Songzanlin Monastery Shangri-La' },
  { re: /납벽해|Napa\s*Lake|纳帕海/i, en: 'Napa Lake Shangri-La Yunnan' },
  { re: /속하\s*고진|Shuhe|束河/i, en: 'Shuhe Ancient Town Lijiang' },
  { re: /흑룡담|Black\s*Dragon\s*Pool|黑龙潭/i, en: 'Black Dragon Pool Lijiang' },
  { re: /리장|여강|Lijiang|丽江/i, en: 'Lijiang Old Town Yunnan' },
  { re: /악마의\s*목구멍|Devil'?s?\s*Throat|Garganta\s*del\s*Diablo/i, en: "Iguazu Falls Devil's Throat waterfall" },
  { re: /푸에르토\s*이구아수|Puerto\s*Iguazu|Puerto\s*Iguazú/i, en: 'Puerto Iguazu Argentina waterfall' },
  { re: /상파울루|상\s*파울로|Sao\s*Paulo|São\s*Paulo/i, en: 'Sao Paulo Brazil skyline' },
  { re: /아디스\s*아바바|Addis\s*Ababa/i, en: 'Addis Ababa Ethiopia' },
  ...
  { re: /아틀란티스\s*(?:더\s*)?팜|Atlantis\s*(?:The\s*)?Palm/i, en: "Atlantis The Palm Dubai" },
  { re: /금\s*시장|향료\s*시장|Gold\s*Souk|Spice\s*Souk/i, en: "Gold Souk spice market" },
  // REGRESSION-FREEZE[register-pre-photo-verify-heal-off-trip-keyword]: 후르가다·엘고나 사파리 ≠ 두바이 — manifest
  { re: /엘\s*고나|엘고나|El\s*Gouna/i, en: "El Gouna marina" },
  { re: /(?:후르가다|후루가다|Hurghada).{0,64}(?:사막\s*)?사파리/i, en: "Red Sea desert safari" },
  ...
  { re: /로드\s*투\s*하나|Road\s*to\s*Hana/i, en: "Road to Hana Maui Hawaii coast" },
  ...
  // REGRESSION-FREEZE[schedule-poi-regex-ssot]: ModeTour AIP102 Manado day-route POI — bare city≠Jesus/Siladen — manifest
  { re: /축복.*예수|Blessing.*Jesus|예수\s*상\s*전망|Yesus\s*Blessing/i, en: "Blessing Jesus Statue" },
  { re: /마카테테|Makatete/i, en: "Makatete Hill" },
  { re: /반힝키옹|Ban\s*Hing\s*Kiong/i, en: "Ban Hing Kiong Temple" },
  { re: /성모\s*마리아\s*대성당|Immaculate\s*Conception\s*Cathedral/i, en: "Manado Cathedral" },
  { re: /센트럼\s*마나도\s*교회|Centrum\s*Manado/i, en: "Centrum Manado Church" },
  { re: /마나도\s*베이|Manado\s*Bay/i, en: "Manado Bay" },
  ...
  // REGRESSION-FREEZE[pexels-normalize-da-nang-not-da]: 테를지·테렐지 단독도 국립공원 — manifest
  { re: /테[를렐]지(?!\s*미라지)/u, en: "Terelj National Park" },
  { re: /거북\s*바위|Turtle\s*Rock/i, en: "Turtle Rock" },
  { re: /아ri?ya발\s*사원|아리{1,2}ya?발\s*사원|아리iya발|야리야발|Ariyabal/i, en: "Ariyabal Temple" },
  ...
  // REGRESSION-FREEZE[schedule-poi-regex-ssot]: 몬세라트 수도원 Montserrat — manifest
  { re: /몬세라트|Montserrat/i, en: "Montserrat Monastery Spain mountain" },
  ...
  { re: /리우\s*데\s*자네이[로루]|리오\s*데\s*자네이[로루]|Rio\s*de\s*Janeiro/i, en: "Rio de Janeiro Christ the Redeemer" },
  ...
  // waterfront/sunset finalize strip → bare Kota Kinabalu 회귀 — Signal Hill로 고정
  { re: /KK\s*스타\s*라운지|KK\s*Star\s*Lounge|Signal\s*Hill\s*Kota\s*Kinabalu/i, en: "Signal Hill Kota Kinabalu" },
...
export const SCHEDULE_CITY_KO_REGEX_RULES: ReadonlyArray<{ re: RegExp; en: string }> = [
  ...
  { re: /타슈켄트|타쉬켄트|Tashkent|타슈켄/i, en: 'Tashkent' },
  { re: /비쉬켁|비슈케크|Bishkek/i, en: 'Bishkek' },
  ...
  // REGRESSION-FREEZE[pexels-normalize-da-nang-not-da]: 다낭 도시명 ≠ Da 조각 — manifest
  { re: /다낭/u, en: "Da Nang" },
  { re: /위해|웨이하이|Weihai/i, en: "Weihai" },
  ...
  { re: /이스터섬|Easter\s*Island/i, en: 'Easter Island' },
  { re: /산티아고|Santiago/i, en: 'Santiago Chile' },
  { re: /몬테레이|Monterrey/i, en: 'Monterrey' },
  ...
  // REGRESSION-FREEZE[schedule-poi-regex-ssot]: 「거리가」≠ 리가 Riga — manifest
  { re: /(?<![가-힣])리가(?![가-힣])|\bRiga\b/i, en: "Riga Latvia Art Nouveau street" },
  ...
  { re: /모나코|Monaco/i, en: "Monaco Monte Carlo harbor" },
  // REGRESSION-FREEZE[register-pre-photo-heal-prisma-retry]: 마르세유·보클뤼즈·엑상 프로방스 중간일 채움 — manifest
  { re: /마르세유|Marseille/i, en: "Marseille Old Port" },
  { re: /보클뤼즈|퐁텐\s*드\s*보클뤼즈|Fontaine\s*de\s*Vaucluse|\bVaucluse\b/i, en: "Fontaine de Vaucluse" },
  { re: /엑상\s*프로방스|엑상프로방스|Aix[- ]?en[- ]?Provence/i, en: "Aix en Provence Cours Mirabeau" },
  ...
  { re: /리우\s*데\s*자네이[로루]|Rio\s*de\s*Janeiro/i, en: "Rio de Janeiro Christ the Redeemer view" },
...
// REGRESSION-FREEZE[schedule-poi-regex-ssot]: 홍콩 디즈니랜드 ≠ Tokyo/Shanghai — manifest
/** 고궁박물관 — 홍콩 서구룡(M+) ≠ 대만 국립고궁 */
// REGRESSION-FREEZE[register-hk-gogung-not-taipei-npm]: 홍콩 고궁 ≠ 대만 국립고궁 — manifest
export function routeContextualPalaceMuseumEnglish(
  seg: string,
  routeText?: string | null,
  productDestination?: string | null,
): string {
  if (!/고궁\s*박물관|Palace\s*Museum/i.test(seg)) return ''
  const ctx = `${String(routeText ?? '')} ${String(productDestination ?? '')} ${seg}`
  if (/홍콩\s*고궁|Hong\s*Kong\s*Palace/i.test(seg)) return 'Hong Kong Palace Museum'
  if (/국립\s*고궁|National\s*Palace\s*Museum/i.test(seg) && !/Hong\s*Kong/i.test(seg)) {
    return 'National Palace Museum Taipei'
  }
  const hkTrip = /홍콩|Hong\s*Kong|香港|마카오|Macau|澳門|\bM\+|서구룡|West\s*Kowloon/i.test(ctx)
  const twTrip = /대만|타이완|Taiwan|타이페이|타이베이|Taipei|가오슝/i.test(ctx)
  if (hkTrip && !twTrip) return 'Hong Kong Palace Museum'
  if (twTrip && !hkTrip) return 'National Palace Museum Taipei'
  if (/\bM\+|서구룡|West\s*Kowloon|구룡성채|침사추이/i.test(`${routeText ?? ''} ${seg}`)) {
    return 'Hong Kong Palace Museum'
  }
  if (/타이페이|타이베이|Taipei|국립/i.test(`${routeText ?? ''} ${seg}`)) {
    return 'National Palace Museum Taipei'
  }
  return ''
}
