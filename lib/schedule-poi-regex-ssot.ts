...
export const SCHEDULE_CITY_KO_REGEX_RULES: ReadonlyArray<{ re: RegExp; en: string }> = [
  ...
  { re: /북경|베이징|北京/u, en: 'Forbidden City Beijing' },
  { re: /경산\s*공원|Jingshan\s*Park/i, en: 'Jingshan Park Beijing Forbidden City view' },
  { re: /만리장성|Great\s*Wall/i, en: 'Great Wall of China' },
  { re: /이화원|Summer\s*Palace/i, en: 'Summer Palace Beijing' },
