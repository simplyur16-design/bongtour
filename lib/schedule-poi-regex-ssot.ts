...
export const SCHEDULE_SPOT_KO_REGEX_RULES: ReadonlyArray<{ re: RegExp; en: string }> = [
  ...
  { re: /천자산|Tianzi\s*Mountain/i, en: "Tianzi Mountain Zhangjiajie pillar peaks" },
  { re: /천문산|Tianmen\s*Mountain|天門山/u, en: "Tianmen Mountain Zhangjiajie cable car" },
  { re: /보봉탑|원가계|Avatar\s*Hallelujah|아바타/i, en: "Avatar Hallelujah Mountain Zhangjiajie" },
  { re: /십리\s*화랑|十里画廊|Ten\s*Mile\s*Gallery|Shili\s*Gallery/i, en: "Ten Mile Gallery Zhangjiajie valley trail" },
  { re: /보봉호|宝峰湖|Baofeng\s*Lake/i, en: "Baofeng Lake Zhangjiajie emerald water" },
  { re: /금편계곡|Golden\s*Whip/i, en: "Golden Whip Stream Zhangjiajie valley" },
  { re: /백룡|百龍|Bailong\s*Elevator|玻璃桥|Glass\s*Bridge/i, en: "Zhangjiajie Grand Canyon Glass Bridge" },
  { re: /황룡\s*동굴|Yellow\s*Dragon\s*Cave|黄龙洞/u, en: "Yellow Dragon Cave Zhangjiajie underground river" },
  { re: /황石寨|黄石寨|Huangshi\s*Village|黄石/u, en: "Huangshi Village Zhangjiajie viewpoint" },
  { re: /미혼대/i, en: "Avatar Mountain Zhangjiajie pillar peaks" },
  { re: /천하일랑/i, en: "Tianxia Yilang Zhangjiajie bridge viewpoint" },
  { re: /백장협/i, en: "Bailong Elevator Zhangjiajie cliff lift" },
  { re: /72\s*기루|七十二奇楼/u, en: "Zhangjiajie 72 Qilou cultural building night" },
  ...
  { re: /하와\s*마할|Hawa\s*Mahal/i, en: 'Hawa Mahal Jaipur pink facade India' },
  { re: /암베르\s*성|Amber\s*Fort/i, en: 'Amber Fort Jaipur India' },
  { re: /쿠트브|Qutub/i, en: 'Qutub Minar Delhi India' },
  { re: /인도\s*게이트|India\s*Gate/i, en: 'India Gate New Delhi' },
  { re: /자이푸르|Jaipur/i, en: 'Hawa Mahal Jaipur pink facade India' },
  ...
  { re: /레기스탄|Registan/i, en: "Registan Square Samarkand Uzbekistan" },
  { re: /아프로시압|Afrosiyab/i, en: "Afrosiyab ancient ruins Samarkand Uzbekistan" },
  { re: /울루그벡|Ulugbek|Ulugh\s*Beg/i, en: "Ulugh Beg Observatory Samarkand Uzbekistan" },
  { re: /구르\s*아미르|Gur[-\s]*e?\s*Amir/i, en: "Gur-e Amir Mausoleum Samarkand Uzbekistan" },
  { re: /샤히진다|Shah[-\s]*i[-\s]*Zinda/i, en: "Shah-i-Zinda necropolis Samarkand Uzbekistan" },
  { re: /비비하눔|Bibi[-\s]*Khanym/i, en: "Bibi-Khanym Mosque Samarkand Uzbekistan" },
  { re: /침볼락|Chimbulak|Shymbulak/i, en: "Shymbulak ski resort Almaty Kazakhstan" },
  { re: /젠코바|Zenkov/i, en: "Zenkov Cathedral Almaty Kazakhstan" },
