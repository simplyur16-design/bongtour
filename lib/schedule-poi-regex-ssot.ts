...
export const SCHEDULE_SPOT_KO_REGEX_RULES: ReadonlyArray<{ re: RegExp; en: string }> = [
  ...
  { re: /니스\s*해변|니스\s*구시가|^니스$|Nice\s*Beach/i, en: "Promenade des Anglais Nice Beach" },
  ...
  { re: /드레스덴\s*성모|Frauenkirche\s*Dresden|Zwinger/i, en: "Dresden Frauenkirche" },
  { re: /뉘른베르크\s*(?:성|고성)|Nuremberg\s*Castle/i, en: "Nuremberg Castle" },
  { re: /성모교회|Frauenkirche\s*Munich|Marienkirche/i, en: "Frauenkirche Munich" },
  ...
  { re: /드레스덴|Dresden/i, en: "Dresden Frauenkirche" },
  { re: /뮌헨|Munich|M[uü]nchen/i, en: "Marienplatz Munich" },
  { re: /베를린|Berlin/i, en: "Brandenburg Gate Berlin" },
  { re: /프랑크푸르트|Frankfurt/i, en: "Romerberg Frankfurt" },
