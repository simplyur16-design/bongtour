/** [naeiltour] admin-register-verification-meta */
/**
...
import type { PricePromotionFieldIssue } from '@/lib/price-promotion-naeiltour'
import type { RegisterExtractionFieldIssue } from '@/lib/register-llm-schema-naeiltour'
import { normalizeNaeiltourFlightLabelStrict } from '@/lib/text-encoding-guard'
...
function NaeiltourVerificationFlightLabel(brandKey: string, s: string | null | undefined): string | null {
  if (brandKey !== 'naeiltour') return s ?? null
  return normalizeNaeiltourFlightLabelStrict(s)
}
...
export function buildRegisterVerificationBundle(args: {
  ...
  return {
    ...
    display: {
      flight: {
        airlineName: NaeiltourVerificationFlightLabel(
          brandKey,
        ...
        departureSegmentText: NaeiltourVerificationFlightLabel(
          brandKey,
          parsed.departureSegmentText ?? productDraft?.departureSegmentText ?? null
        ),
        returnSegmentText: NaeiltourVerificationFlightLabel(
          brandKey,
...
export { REGISTER_PUBLIC_PAGE_TRACE_BULLETS } from '@/lib/admin-register-trace-bullets'
