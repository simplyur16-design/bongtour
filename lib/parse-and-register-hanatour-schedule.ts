...
import {
  ...
  hanatourJoinedHasTourismEvidence,
  hanatourMovementSignalsStrong,
  inferHanatourMovementTitle,
...
function resolveHanatourAirtelFreeTravelImageKeywordFromHaystackLocal(hay: string): string {
  ...
  const cityRules: ReadonlyArray<{ re: RegExp; en: string }> = [
    ...
    { re: /본다이\s*비치|본다이|Bondi/i, en: 'Bondi Beach' },
    { re: /블루\s*마운틴|Blue\s*Mountain/i, en: 'Blue Mountains' },
    { re: /포트\s*스티븐|Port\s*Stephens/i, en: 'Port Stephens' },
    { re: /시드니|Sydney/i, en: 'Sydney Opera House harbour bridge view' },
    { re: /멜번|Melbourne/i, en: 'Melbourne Federation Square skyline' },
    ...
    { re: /후쿠오카|福岡|Fukuoka/i, en: 'Fukuoka Ohori Park castle view' },
