 ...
 * REGRESSION-FREEZE[product-image-seo-coreinfo-airline-contamination]: 여행핵심정보·항공여정에서 수확 중단 — manifest
 */
...
const SECTION_STOP =
  /^(?:포함사항|불포함|유의사항|예약|취소|미팅|항공|선택관광|현지옵션|일정\s*표|상품\s*안내|상품\s*소개|여행\s*후기|고객\s*(?:리뷰|후기)|상품\s*평점|평균\s*별점|리뷰|여행\s*핵심\s*정보|상품\s*핵심\s*정보|핵심\s*정보|항공\s*여정|항공\s*사|요약\s*(?:정보|설명)|여행\s*기간|여행\s*도시|출발\s*인원|상품\s*특전|편명)/
