...
const REGION_TITLE_RE =
  /미동부|미서부|미남부|미국\s*일주|캐나다|미국|(?<![가-힣])동부(?![가-힣])|(?<![가-힣])서부(?![가-힣])|(?<![가-힣])남부(?![가-힣])|유럽|일본|중국|동남아|호주|괌|하와이|싱가포르|태국|베트남|필리핀|대만|홍콩|마카오|다낭|북해도|오사카|도쿄|방콕|튀르키|터키|나트랑|푸꾸옥|코타|발리|세부|치앙|이탈리아|독일|프랑스|스페인|스위스|포르투갈|오스트리아|영국|잉글랜드|스코틀랜드|아일랜드|웨일즈|돌로미티/i
