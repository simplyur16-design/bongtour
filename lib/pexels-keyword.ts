...
const DESTINATION_MAP: Record<string, string> = {
  ...
  상해: 'Shanghai',
  // REGRESSION-FREEZE[register-schedule-sea-poi-kw]: 사해≠Shanghai — Dead Sea (요르단) — manifest
  // 「사해」를 상해 오타 별칭으로 쓰면 EMP135 등 중동 일정이 Shanghai로 환각한다.
  사해: 'Dead Sea Jordan',
  '사해 해변': 'Dead Sea Jordan',
  베이징: 'Beijing',
  북경: 'Beijing',
  ...
  이집트: 'Egypt',
  카이로: 'Cairo',
  // REGRESSION-FREEZE[schedule-poi-regex-ssot]: ModeTour EMP151 카이=카이로 truncation — Day2 empty 금지 — manifest
  카이: 'Cairo',
  암만: 'Amman',
  룩소르: 'Luxor',
  아스완: 'Aswan',
  ...
  포르투갈: 'Portugal',
  리스본: 'Lisbon',
  // REGRESSION-FREEZE[schedule-poi-porto-europa-osaka]: before bare 포르투 — manifest
  포르투유럽: 'Porto Europa Osaka',
  '포르투 유럽': 'Porto Europa Osaka',
  포르투: 'Porto',
  브라가: 'Braga',
  신트라: 'Sintra',
  카스카이스: 'Cascais',
  ...
  상파울로: 'Sao Paulo',
  로스엔젤레스: 'Los Angeles',
  // REGRESSION-FREEZE[register-schedule-trip-image-keyword-dedupe]: 로스앤젤레스(앤) DEST soft-dup — manifest
  로스앤젤레스: 'Los Angeles',
  뉴욕: 'New York',
  워싱턴: 'Washington DC',
  토론토: 'Toronto',
...
const POI_KO_TO_EN: Record<string, string> = {
  ...
  // REGRESSION-FREEZE[lottetour-singapore-register-quality]: bare 유니버설 → Japan 기본 금지 — manifest
  유니버설스튜디오재팬오사카: 'Universal Studios Japan',
  센토사: 'Sentosa',
  센토사섬: 'Sentosa',
  머를라이언: 'Merlion Park',
  머라이언: 'Merlion Park',
  ...
  // REGRESSION-FREEZE[schedule-poi-regex-ssot]: ModeTour EMP151 그랜드뮤지엄·콥트 교회 — Day2/9 empty·bleed 금지 — manifest
  그랜드뮤지엄: 'Grand Egyptian Museum',
  '그랜드 뮤지엄': 'Grand Egyptian Museum',
  '행잉 교회': 'Hanging Church',
  행잉교회: 'Hanging Church',
  행잉처치: 'Hanging Church',
  '성조지 교회': 'Saint George Church',
  성조지교회: 'Saint George Church',
  '아기예수 피난 교회': 'Abu Serga Church',
  아기예수피난교회: 'Abu Serga Church',
  '아부 세르가': 'Abu Serga Church',
  아부세르가: 'Abu Serga Church',
  피라미드: 'Giza Pyramids',
  ...
  인디아게이트: 'India Gate',
  '인디아 게이트': 'India Gate',
  // REGRESSION-FREEZE[schedule-poi-regex-ssot]: India AWP902 — Lodhi/Bahai/Akshardham — manifest
  로디가든: 'Lodhi Garden',
  '로디 가든': 'Lodhi Garden',
  미노르모스크: 'Minor Mosque',
  '미노르 모스크': 'Minor Mosque',
  초르수바자르: 'Chorsu Bazaar',
  '초르수 바자르': 'Chorsu Bazaar',
  '하르자트 이맘': 'Hazrati Imam Complex',
  하르자트이맘: 'Hazrati Imam Complex',
  황만금박물관: 'State Museum of History',
  '황만금 박물관': 'State Museum of History',
  '아미르 티무르 광장': 'Amir Timur Square',
  블랙캐년: 'Black Canyon',
  루나캐년: 'Luna Canyon',
  차른캐년: 'Charyn Canyon',
  '차른캐년 협곡': 'Charyn Canyon',
  악수온천: 'Aksu Hot Springs',
  백장협: 'Baizhang Gorge',
  칠성산: 'Seven Star Mountain',
  하룡공원: 'Helong Park',
  '천하제일교': 'First Bridge Under Heaven',
  '바하이 사원': 'Lotus Temple',
  바하이사원: 'Lotus Temple',
  악차르담: 'Akshardham Temple',
  '악차르담 사원': 'Akshardham Temple',
  사르나트: 'Sarnath',
  아르띠뿌자: 'Ganga Aarti',
  '아르띠 뿌자': 'Ganga Aarti',
  나하르가르성: 'Nahargarh Fort',
  '나하르가르 성': 'Nahargarh Fort',
  잔타르만타르: 'Jantar Mantar',
  '후마윤 무덤': 'Humayun Tomb',
  후마윤무덤: 'Humayun Tomb',
  '아바네리 찬드': 'Chand Baori',
  아바네리찬드: 'Chand Baori',
  ...
  비치클럽: 'Tropical beach club coastline',
  ...
  손트랑: 'Phu Quoc Duong Dong night market',
  // REGRESSION-FREEZE[register-schedule-sea-poi-kw]: 2030 live emptyKw route POI — manifest
  // REGRESSION-FREEZE[register-schedule-sea-poi-kw]: 사해≠Shanghai — Dead Sea — manifest
  사해: 'Dead Sea Jordan',
  '사해 해변': 'Dead Sea Jordan',
  아마시아: 'Amasya Turkey riverside',
  '알착 다리': 'Alcak Bridge Amasya Turkey',
  알착: 'Alcak Bridge Amasya Turkey',
  술루아다: 'Suluada Island Antalya snorkeling',
  '술루아다 섬': 'Suluada Island Antalya snorkeling',
  술루다아섬: 'Suluada Island Antalya snorkeling',
  카발란: 'Kavalan Whisky Distillery Taiwan',
  '카발란 위스키': 'Kavalan Whisky Distillery Taiwan',
  장메이: 'Zhangmei Leisure Farm Taiwan',
  '차른 캐니언': 'Charyn Canyon Kazakhstan',
  ...
  '판랑 사막': 'Phan Rang white sand dunes Vietnam',
  '쯩선 사원': 'Po Klong Garai Cham Towers Phan Rang',
  짜뚜짝: 'Chatuchak Weekend Market Bangkok',
  ...
  '시라오 가든': 'Sirao Flower Garden Cebu',
  '시라오 플라워 가든': 'Sirao Flower Garden Cebu',
  '레아 신전': 'Temple of Leah Cebu',
  '와디 럼': 'Wadi Rum desert Jordan',
  와디럼: 'Wadi Rum desert Jordan',
  아마노하시다테: 'Amanohashidate pine sandbar Japan',
  이네후나야: 'Ine Funaya boat houses Kyoto',
  이네후나만: 'Ine Funaya boat houses Kyoto',
  카사마츠공원: 'Kasamatsu Park Amanohashidate',
  류큐무라: 'Ryukyu Mura Okinawa',
  카비라만: 'Kabira Bay Ishigaki',
  ...
  // REGRESSION-FREEZE[register-schedule-sea-poi-kw]: 2030 live emptyKw r2 remain — manifest
  카이저부르크: 'Kaiserburg Castle Nuremberg',
  '중앙 광장': 'Hauptmarkt Nuremberg',
  뉘른베르크: 'Nuremberg old town Germany',
  디화제: 'Dihua Street Taipei',
  다다오청: 'Dadaocheng Taipei',
  PIER5: 'Dadaocheng Pier 5 Taipei',
  '다다오청 PIER5': 'Dadaocheng Pier 5 Taipei',
  '코코 바구니배': 'Nha Trang basket boat coracle',
  코코배: 'Nha Trang basket boat coracle',
  바나나보트: 'Tunku Abdul Rahman Marine Park Kota Kinabalu',
  // 서핑은 목적지 의존 — 오키나와 전용 문구만 매핑 (가고시마 서핑→Okinawa 환각 금지)
  '오키나와 서핑': 'Okinawa surfing beach',
  ...
  송성: 'Songcheng Park',
  송가무: 'Songcheng Park',
  항주: 'West Lake Hangzhou',
  // REGRESSION-FREEZE[schedule-poi-regex-ssot]: 서호 단독=하노이 (항주·西湖는 Hangzhou) — manifest
  서호: 'West Lake Hanoi',
  ...
  '괌 스페인광장': 'Plaza de Espana Guam',
  괌스페인광장: 'Plaza de Espana Guam',
  스페인광장: 'Plaza de Espana Seville',
  '스페인 광장': 'Plaza de Espana Seville',
  알함브라궁전: 'Alhambra Palace Granada',
  알함브라: 'Alhambra Palace Granada',
  마세나광장: 'Place Massena Nice',
  '마세나 광장': 'Place Massena Nice',
  프라도미술관: 'Prado Museum Madrid',
  프라도: 'Prado Museum Madrid',
  마드리드왕궁: 'Royal Palace Madrid',
  '마드리드 왕궁': 'Royal Palace Madrid',
  '푸에르타 델 솔': 'Puerta del Sol Madrid',
  푸에르타델솔: 'Puerta del Sol Madrid',
  히랄다탑: 'Giralda Tower Seville',
  히랄다: 'Giralda Tower Seville',
  '세비야 대성당': 'Seville Cathedral',
  황금의탑: 'Torre del Oro Seville',
  ...
  사그레스: 'Sagres fortress Portugal',
  상비센테곶: 'Cape St Vincent Portugal',
  '상비센테 곶': 'Cape St Vincent Portugal',
  알부페이라: 'Albufeira Algarve beach Portugal',
  그랑카지노: 'Monte Carlo Casino Monaco',
  '아비뇽 다리': 'Pont d Avignon',
  '아를 구시가지': 'Arles Amphitheatre Provence',
  '아를 구시가': 'Arles Amphitheatre Provence',
  ...
  '포르투 유럽': 'Porto Europa Osaka',
  포르투유럽: 'Porto Europa Osaka',
  'Porto Europa': 'Porto Europa Osaka',
  ...
  '부이페스트 바자': 'Vui Pnest Night Market',
  부이페스트: 'Vui Pnest Night Market',
  그랜드월드: 'Grand World',
  '그랜드 월드': 'Grand World',
  ...
  썬월드: 'Phu Quoc Hon Thom Cable Car',
  딘커우: 'Dinh Cau Temple',
  '딘커우 사원': 'Dinh Cau Temple',
  쯔엉동야시장: 'Duong Dong Night Market',
  '쯔엉동 야시장': 'Duong Dong Night Market',
  쯔엉동: 'Duong Dong Night Market',
  후추농장: 'Phu Quoc Pepper Farm',
  '후추 농장': 'Phu Quoc Pepper Farm',
  ...
  몬세라트: 'Montserrat Monastery Spain',
  '몬세라트 수도원': 'Montserrat Monastery Spain',
  ...
  // REGRESSION-FREEZE[register-facts-fetch-resilience]: US west routeText POI → imageKeyword — manifest
  요세미티: 'Yosemite National Park',
  '요세미티 국립공원': 'Yosemite National Park',
  '요세미티 국립 공원': 'Yosemite National Park',
  엘카피탄: 'El Capitan Yosemite',
  '면사포 폭포': 'Bridalveil Fall Yosemite',
  면사포폭포: 'Bridalveil Fall Yosemite',
  '인스피레이션 포인트': 'Inspiration Point Yosemite',
  그랜드캐년: 'Grand Canyon',
  '그랜드 캐년': 'Grand Canyon',
  ...
  '어부의 선착장': "Fisherman's Wharf San Francisco",
  '팔레스 오브 파인 아트': 'Palace of Fine Arts San Francisco',
  트윈픽스: 'Twin Peaks San Francisco',
  앤텔로프캐년: 'Antelope Canyon',
  '앤텔로프 캐년': 'Antelope Canyon',
  // Alaska cruise / Seattle
  '퍼블릭 마켓': 'Pike Place Market Seattle',
  퍼블릭마켓: 'Pike Place Market Seattle',
  '스타벅스 1호점': 'Starbucks Original Store Seattle',
  '알카이 비치': 'Alki Beach Seattle',
  알카이비치: 'Alki Beach Seattle',
  글래시어베이: 'Glacier Bay Alaska',
  '글래시어 베이': 'Glacier Bay Alaska',
  주노: 'Juneau Alaska',
  스캐그웨이: 'Skagway Alaska',
  스케그웨이: 'Skagway Alaska',
  케치칸: 'Ketchikan Alaska',
  '화이트 패스': 'White Pass Yukon Railroad',
  화이트패스: 'White Pass Yukon Railroad',
  이너하버: 'Inner Harbour Victoria',
  '이너 하버': 'Inner Harbour Victoria',
  // REGRESSION-FREEZE[register-facts-fetch-resilience]: operator-batch emptyKw POI fill — manifest
  바스토우: 'Barstow Route 66 California',
  로스앤젤레스: 'Hollywood Sign Los Angeles',
  로스엔젤레스: 'Hollywood Sign Los Angeles',
  라스베이거스: 'Las Vegas Strip',
  라스베가스: 'Las Vegas Strip',
  라플린: 'Laughlin Colorado River',
  코닥극장: 'TCL Chinese Theatre Hollywood',
  '코닥 극장': 'TCL Chinese Theatre Hollywood',
  니지노마츠바라: 'Nijinomatsubara pine grove Saga',
  // REGRESSION-FREEZE[pexels-keyword-kk-fireflies-context]: KK 스타 라운지 → Signal Hill Kota Kinabalu (Petronas 중복키 금지) — manifest
  ...
  '축복하는 예수상': 'Blessing Jesus Statue',
  // REGRESSION-FREEZE[schedule-poi-regex-ssot]: ModeTour AIP102 Manado day-route POI — bare city≠Jesus/Siladen — manifest
  반힝키옹: 'Ban Hing Kiong Temple',
  '반힝키옹 사원': 'Ban Hing Kiong Temple',
  '성모 마리아 대성당': 'Manado Cathedral',
  '센트럼 마나도 교회': 'Centrum Manado Church',
  '마나도 베이': 'Manado Bay',
  실라덴: 'Siladen Island',
  '실라덴섬': 'Siladen Island',
  '실라덴 섬': 'Siladen Island',
  ...
  상파울로: 'Sao Paulo Cathedral',
  비엔티엔: 'Patuxai Monument Vientiane',
  '비엔티엔 근교': 'Buddha Park Vientiane',
  비엔티안: 'Pha That Luang Vientiane',
  신닷: 'That Luang Vientiane',
  // 삿포/삿포로 bare city는 DESTINATION_MAP(Sapporo). 오도리공원은 명시 POI만.
  오도리공원: 'Odori Park Sapporo',
  '오도리 공원': 'Odori Park Sapporo',
  장백폭포: 'Changbai Waterfall',
  녹연담: 'Green Pool Changbai Mountain',
  지하삼림: 'Underground Forest Changbai',
  '온천지대': 'Changbai Hot Springs',
  '5D플라잉': 'Changbai Mountain Flight Theater',
  생테밀리옹: 'Saint Emilion Village France',
  '보르도 생테밀리옹 와이너리': 'Saint Emilion Winery Bordeaux',
  '프랑스/생테밀리옹': 'Saint Emilion Village France',
  카르카손: 'Carcassonne Castle',
  솔로프라: 'Solopaca Italy',
  '이탈리아/솔로프라': 'Solopaca Italy',
  '트롤리 마을': 'Trulli Houses Alberobello',
  마테라: 'Matera Cave Dwellings',
  '오래된동굴 주거군락': 'Matera Sassi Cave Houses',
  포덴차: 'Potenza Italy Historic Center',
  '레오디나스 청동상': 'Leonidas Monument Thermopylae',
  '레오디나스 청동상 조망': 'Leonidas Monument Thermopylae',
  테르모필레: 'Thermopylae Greece',
  '아테네 야경': 'Acropolis Athens night view',
  '티톱섬 전망대': 'Ti Top Island Halong Bay',
  '티톱섬': 'Ti Top Island Halong Bay',
  석회동굴: 'Surprise Cave Halong Bay',
  '하롱베이 석회동굴': 'Surprise Cave Halong Bay',
  '하롱 석회동굴': 'Surprise Cave Halong Bay',
  그랑거리: 'Grande Rue shopping Nice',
  '대분수 광장': 'Fontaine du Soleil Nice',
  '크루아제트 대': 'Croisette Cannes',
  '프롬나드 데 장글래': 'Promenade des Anglais Nice',
  '니스 해변': 'Promenade des Anglais Nice Beach',
  '니스 구시가지': 'Old Town Nice France',
  촐폰아타: 'Cholpon Ata Kyrgyzstan',
  '알라아르차 국립공원': 'Ala Archa National Park',
  알라아르차: 'Ala Archa National Park',
  이식쿨호수: 'Issyk Kul Lake',
  '이식쿨 호수': 'Issyk Kul Lake',
  이식쿨유람선: 'Issyk Kul Lake Cruise',
  '르호르도 종교관': 'Rukh Ordo Cultural Center',
  암각화박물관: 'Petroglyph Museum Cholpon Ata',
  알라투광장: 'Ala Too Square Bishkek',
  승리광장: 'Victory Square Bishkek',
  '바자르 시장': 'Osh Bazaar Bishkek',
  오르후스: 'Aarhus Cathedral Denmark',
  오덴세: 'Hans Christian Andersen Museum Odense',
  빌뉴스: 'Gediminas Tower Vilnius',
  '리투아니아/빌뉴스': 'Gediminas Tower Vilnius',
  '빌뉴스 대성당': 'Vilnius Cathedral',
  '새벽의 문': 'Gate of Dawn Vilnius',
  '성 안나 교회': 'St Anne Church Vilnius',
  '빌뉴스 대학교': 'Vilnius University Courtyard',
  갠지스강: 'Ganges River',
  '갠지스 강': 'Ganges River',
  // REGRESSION-FREEZE[schedule-image-keyword-dual-slot]: Khajuraho Complex≡Temples semantic — manifest
  '서부 사원군': 'Khajuraho Temples',
  '동부 사원군': 'Khajuraho Temples',
  '서부 사원군 & 동부 사원군': 'Khajuraho Temples',
  카주라호: 'Khajuraho Temples',
  '작은 인어상': 'Little Mermaid Copenhagen',
  '크리스티안스보르 궁전': 'Christiansborg Palace Copenhagen',
  '게피온 분수대': 'Gefion Fountain Copenhagen',
  ...
  '캐필라노 연어 부화장': 'Capilano Salmon Hatchery',
  '연어 양식장': 'Capilano Salmon Hatchery',
  씨월드: 'SeaWorld Abu Dhabi',
  '페라리 월드': 'Ferrari World Abu Dhabi',
  '워너 브라더스 월드': 'Warner Bros World Abu Dhabi',
  '야스아일랜드 테마파크': 'Yas Island Theme Park',
  // 사이판 PIC 일정 관용구 — 제주 새섬(Saeseom)과 혼동 금지
  '천혜의 자연 새섬': 'Saipan Bird Island',
  마나가하: 'Managaha Island Saipan',
  마나가하섬: 'Managaha Island Saipan',
  만세절벽: 'Suicide Cliff Saipan',
  '한국인 위령탑': 'Korean Peace Memorial Saipan',
  '조텐 쇼핑센터': 'Joeten Shopping Center Saipan',
  조텐: 'Joeten Shopping Center Saipan',
  ...
  정어리떼: 'Mactan Sardine Snorkeling',
  '정어리떼 스노클링': 'Mactan Sardine Snorkeling',
  정어리떼스노클링: 'Mactan Sardine Snorkeling',
  '막탄 정어리떼': 'Mactan Sardine Snorkeling',
  '막탄 정어리떼 스노클링': 'Mactan Sardine Snorkeling',
  ...
  '대련 동관거리': 'Dongguan Street Dalian',
  동관거리: 'Dongguan Street Dalian',
  러시아거리: 'Russian Street Dalian',
  '대련 러시아거리': 'Russian Street Dalian',
  '연화산 전망대': 'Yanhuashan Viewpoint Dalian',
  연화산: 'Yanhuashan Viewpoint Dalian',
  성해광장: 'Xinghai Square Dalian',
  동방수성: 'Oriental Water City Dalian',
  여순감옥: 'Lushun Prison Museum Dalian',
  '여순관동법원': 'Lushun Court Museum Dalian',
  프레이케스톨렌: 'Preikestolen Pulpit Rock Norway',
  프레이케스톨론: 'Preikestolen Pulpit Rock Norway',
  '십자가의 언덕': 'Hill of Crosses Lithuania',
  레르달: 'Laerdal Norway Fjord',
  '스웨덴 왕궁': 'Stockholm Royal Palace',
  '스톡홀름 왕궁': 'Stockholm Royal Palace',
  '스톡홀름 시청': 'Stockholm City Hall',
  카즈베즈: 'Mount Kazbek Georgia',
  '게르게티 츠민다 사메바 교회': 'Gergeti Trinity Church',
  '나리칼라 성': 'Narikala Fortress Tbilisi',
  시오니대성당: 'Sioni Cathedral Tbilisi',
  '성삼위 사메바 교회': 'Sameba Cathedral Tbilisi',
  알라베르디: 'Alaverdi Monastery Armenia',
  예레반: 'Cascade Complex Yerevan',
  '아그파트 수도원': 'Haghpat Monastery',
  꼬냑박물관: 'Ararat Cognac Museum Yerevan',
  코비랍: 'Khor Virap Monastery',
  '코비랍 수도원': 'Khor Virap Monastery',
  '게하르트 수도원': 'Geghard Monastery',
  '아라랏 산': 'Mount Ararat View',
  '가르니 신전': 'Garni Temple Armenia',
  '초베국립공원': 'Chobe National Park',
  '초베국립공원 보트사파리': 'Chobe River Boat Safari',
  '초베 사륜구동 게임 드라이브 사파리': 'Chobe Game Drive Safari',
  '빅토리 폴스': 'Victoria Falls',
  '미완성의 오벨리스크': 'Unfinished Obelisk Aswan',
  필레신전: 'Philae Temple Aswan',
  '누비안 빌리지': 'Nubian Village Aswan',
  ...
  인컨타라: 'Xiangshawan Desert Ordos',
  '옌뜨 국립공원': 'Yen Tu National Park Vietnam',
  '옌뜨 국립공원+케이블카': 'Yen Tu National Park Cable Car',
  옌뜨: 'Yen Tu National Park Vietnam',
  '벨베데레 궁전': 'Belvedere Palace Vienna',
  '벨베데레 궁전 상궁': 'Belvedere Palace Vienna',
  '벨베데레 상궁': 'Belvedere Palace Vienna',
  '성 슈테판 성당': 'St Stephens Cathedral Vienna',
  '케른트너 거리': 'Kartner Strasse Vienna',
  루브르: 'Louvre Museum Paris',
  '사디얏 아일랜드': 'Saadiyat Island Abu Dhabi',
  '사디얏 아일랜드 문화': 'Saadiyat Island Cultural District',
  '아랍에미리트 대통령궁': 'Qasr Al Watan Presidential Palace',
  '마꾸꼬 사파리': 'Macuco Safari Iguazu Falls',
  '정글 속 짜릿한 모험 마꾸꼬 사파리': 'Macuco Safari Iguazu Falls',
}
