/** [verygoodtour] register-correction-preview */
/**
...
} from '@/lib/register-correction-types-verygoodtour'
import { issueBadge } from '@/lib/register-preview-ssot-verygoodtour'
import {
...
/** `register-preview-ssot-verygoodtour`의 issueBadge 와 동일 배지 산출 — 동일 공급사 모듈 내 헬퍼 */
