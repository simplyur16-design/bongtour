...
- **1일차·마지막 일차·출발·귀국(비행) 일차:** imageKeyword = **해외 목적/방문 도시 영문명**(첫 방문 도시·마지막 방문 도시, 동일 가능). routeText가 인천만이어도 **상품 destination·다른 일차 routeText**에서 첫·마지막 해외 도시를 쓴다. imageKeyword2는 null. 인천·김포·ICN 등 국내 허브 금지.
