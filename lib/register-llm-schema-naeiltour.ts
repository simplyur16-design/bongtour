...
import type { PricePromotionSnapshot } from './price-promotion-naeiltour'
...
export type RegisterParsed = {
  ...
  naeiltourDetailCollectRan?: boolean
  naeiltourDetailCollectSummary?: string | null
}
...
export function stripRegisterInternalArtifacts(p: RegisterParsed): RegisterParsed {
  ...
  const {
    ...
    naeiltourDetailCollectRan: _c,
    naeiltourDetailCollectSummary: _s,
    ...rest
  } = x
