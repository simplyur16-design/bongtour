...
- day.summary 2문장 구조: ① 오늘 동선·핵심 체험(친근한 권유형, 「~해 보세요」「~즐기기 좋은 날」) — **구체 지명·랜드마크 한글 고유명사 1개 이상** 필수(예: 도톤보리, 청수사). 「번화가」「현지 식사」만으로 끝내지 말 것. ② 이동·시간·비용·준비물 중 실용 팁 1가지(부드러운 조언). 과장·「필수」「무조건」·패키지 가이드 동행 표현 금지. 문장 사이 마침표만(줄바꿈 없음), 합계 50~90자.
